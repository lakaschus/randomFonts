...
from .utils import scale_back, merge, save_concat_images, save_concat_images_interp
...
class UNet(object):
    ...
    def interpolate(self, source_obj, between, model_dir, save_dir, steps):
        ...
        for step_idx in range(len(alphas)):
            ...
            if len(batch_buffer):
                print("C1!!!!!!!!!")
                save_concat_images(batch_buffer, save_dir)
                #save_concat_images_interp(batch_buffer,
